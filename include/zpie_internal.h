 ...
 *
 * zpie_internal.h - Internal definitions (not part of the public API)
 *
 * Author: xevisalle
 */

#ifndef ZPIE_INTERNAL_H
#define ZPIE_INTERNAL_H
...
/* ------------------------------------------------------------------------- */
/* System includes used internally                                           */
/* ------------------------------------------------------------------------- */
